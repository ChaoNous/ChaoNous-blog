// Auto-generated SVG icon data for Svelte components
...
export const ICON_SVG_DATA: Record<string, IconData> = {
  ...
  "fa7-solid:chevron-right": {
    body: `<path fill="currentColor" d="M471.1 297.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L403.2 320L233.9 150.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/>`,
    width: 640,
    height: 640,
  },
